...
import {
  Users, Building2, Briefcase, MessageSquare,
    ...
    <div className="min-h-screen bg-slate-950 text-white p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={fetchAll}
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm bg-slate-900 border border-slate-800 text-slate-400 hover:text-white transition-colors"
          >
          ...
          <div className="divide-y divide-slate-800">
            {loading ? (
              ...
              <div
                ...
                className="flex items-center gap-3 px-5 py-3.5 cursor-pointer transition-colors hover:bg-slate-800/50"
                style={{ background: selected === t.id ? "rgba(79,70,229,0.1)" : "transparent" }}
              >
                <div className="w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 bg-indigo-900/40 text-indigo-400">
